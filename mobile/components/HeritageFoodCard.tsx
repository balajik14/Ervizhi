        ...
        <View style={Platform.OS === 'web' ? { className: 'heritage-card-hover', height: '100%' } as any : { height: '100%' }}>
          ...
          >
            ...
            <View style={styles.siddhaBox}>
              ...
              <Text style={styles.siddhaText}>{food.siddhaWisdom}</Text>
            </View>
            ...
            <View style={styles.comparisonBox}>
              <Text style={styles.comparisonTitle}>Modern vs Ancient Health</Text>
              <View style={styles.compRow}>
                <Text style={styles.compLabel}>GI Index (Lower=Better):</Text>
                <Text style={styles.compVal}>Modern: {food.comparison.giIndex.modern} | Ancient: <Text style={{ color: '#10B981', fontWeight: 'bold' }}>{food.comparison.giIndex.ancient}</Text></Text>
              </View>
              <View style={styles.compRow}>
                <Text style={styles.compLabel}>Fiber (Higher=Better):</Text>
                <Text style={styles.compVal}>Modern: {food.comparison.fiber.modern}g | Ancient: <Text style={{ color: '#10B981', fontWeight: 'bold' }}>{food.comparison.fiber.ancient}g</Text></Text>
              </View>
              <Text style={styles.healthImpact}>{food.comparison.healthImpact}</Text>
            </View>
